var Schema, settingsValidator, should, userValidator;
...
describe("OBJ-SCHEMA -", function() {
  ...
  describe('Main -', function() {
    ...
    it("missing required", function(done) {
      var err;
    ...
    it("invalid timezone", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        email: "john@do.com",
    ...
    it("invalid subschema type", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        email: "john@do.com",
    ...
    it("invalid subschema required", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        email: "john@do.com",
    ...
    it("faling number check", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        email: "john@do.com",
    ...
    it("faling number check eq", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        email: "john@do.com",
    ...
    it("faling number check neq", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        email: "john@do.com",
    ...
    it("faling number regex", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        sex: "X"
    ...
    it("faling string length too low", function(done) {
      var err;
      err = userValidator.validate({
        name: "Jo",
        email: "john@do.com",
    ...
    it("faling string length too high", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        nickname: "johntheipsumdo",
        age: 0
      });
      should.exist(err);
    ...
    it("faling string length neq - low", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        type: "x",
    ...
    it("faling string length neq - high", function(done) {
      var err;
      err = userValidator.validate({
        name: "John",
        type: "abc",
